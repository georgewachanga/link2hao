...
<head>
    ...
    <link href="imported/css/bootstrap.css" rel='stylesheet' type='text/css' />

    <link href="imported/css/style.css" rel='stylesheet' type='text/css' />


    <script type="text/javascript" src="imported/js/jquery-1.11.1.min.js"></script>
    <script type="text/javascript" src="imported/js/login.js"></script>
    <script src="imported/js/jquery.easydropdown.js"></script>
    <script src="imported/js/wow.min.js"></script>
    <link href="imported/css/animate.css" rel='stylesheet' type='text/css' />
    <script>
        new WOW().init();
    </script>
</head>
...
<div class="header">
    <div class="col-sm-8 header-left">
        ...
        <div class="menu">
            <a class="toggleMenu" href="#"><img src="imported/images/nav.png" alt="" /></a>
            <ul class="nav" id="nav">
            ...
            <script type="text/javascript" src="imported/js/responsive-nav.js"></script>
        </div>
        <!-- start search-->
        ...
        <!----search-scripts---->
        <script src="imported/js/classie.js"></script>
        <script src="imported/js/uisearch.js"></script>
        <script>
    ...
    <div class="col-sm-4 header_right">
        <div id="loginContainer"><a href="#" id="loginButton"><img src="imported/images/login.png"><span>Login</span></a>
            <div id="loginBox">
                <form id="loginForm">
                    <fieldset id="body">
                        <fieldset>
        ...
        <div class="content_middle_box">
            <div class="top_grid">
                <div class="col-md-3 index-grids">
                    <div class="grid1">
                        <div class="view view-first">
                            <div class="index_img"><img src="imported/images/pic1.jpg" class="img-responsive" alt=""/></div>
                            <div class="sale">$2.980</div>
                            <div class="mask">
                                <div class="info"><i class="search"> </i> Show More</div>
                                <ul class="mask_img">
                                    <li class="star"><img src="imported/images/star.png" alt=""/></li>
                                    <li class="set"><img src="imported/images/set.png" alt=""/></li>
                                    <div class="clearfix"> </div>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="inner_wrap">
                            ...
                            <ul class="star1">
                                ...
                                <li><a href="#"> <img src="imported/images/star1.png" alt="">(236)</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 index-grids">
                    <div class="grid1">
                        <div class="view view-first">
                            <div class="index_img1"><img src="imported/images/pic6.jpg" class="img-responsive" alt=""/></div>
                            <div class="mask">
                                <div class="info"><i class="search"> </i> Show More</div>
                                <ul class="mask_img">
                                    <li class="star"><img src="imported/images/star.png" alt=""/></li>
                        ...
                        <div class="inner_wrap">
                            ...
                            <ul class="star1">
                                ...
                                <li><a href="#"> <img src="imported/images/star2.png" alt="">(136)</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 index-grids">
                    <div class="grid1">
                        <div class="view view-first">
                            <div class="index_img2"><img src="imported/images/pic2.jpg" class="img-responsive" alt=""/></div>
                            <div class="mask">
                                <div class="info"><i class="search"> </i> Show More</div>
                                <ul class="mask_img">
                                    <li class="star"><img src="imported/images/star.png" alt=""/></li>
                ...
                <div class="col-md-3 index-grids">
                    <div class="grid1">
                        <div class="view view-first">
                            <div class="index_img"><img src="imported/images/pic3.jpg" class="img-responsive" alt=""/></div>
                            <div class="sale">$2.980</div>
                            <div class="mask">
                                <div class="info"><i class="search"> </i> Show More</div>
                                <ul class="mask_img">
            ...
            <div class="middle_grid wow fadeInUp" data-wow-delay="0.4s">
                <div class="col-md-6 index-grids">
                    <div class="grid1">
                        <div class="index_img"><img src="imported/images/pic4.jpg" class="img-responsive" alt=""/></div>
                        <i class="m_home"> </i>
                        <ul class="vision">
                            <li>Vision Agency</li>
                            <li class="desc"><a href="#"> <img src="imported/images/star1.png" alt="">(236)</a></li>
                        </ul>
